<template>
    <section>
        ...
        <el-table :data="resource_list" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
            ...
            <el-table-column prop="name" label="文件名" width="200" sortable>
            </el-table-column>
            <el-table-column prop="size" label="大小" width="100"  sortable>
            </el-table-column>
            <el-table-column prop="price" label="价格" width="100" sortable>
            </el-table-column>
            <el-table-column prop="detail" label="详情" min-width="200" sortable>
            </el-table-column>
            ...
            <el-table-column label="操作" width="250">
                <template scope="scope">
                    ...
                    <el-button type="danger" size="small"  @click="payPopup(scope.row)">解压密码</el-button>
                </template>
            </el-table-column>
        </el-table>
        ...
        <el-dialog title="获取密码" :visible.sync="getCodeModal" width="30%" custom-class="dialog-center" @close="clearOrder()">
            <el-form :model="currentRow">
                ...
                <el-form-item v-if="qrCode" label="微信支付码:" label-width="100px">
                    <img  :src="qrCode"></img>
                </el-form-item>
                <el-form-item v-if="order_password" label="解压密码:" label-width="100px">
            ...
            <div slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" @click="order(currentRow)">确 定</el-button>
            </div>
        </el-dialog>
...
<script>
    ...
    import { payOrder, ListOrderStatus, saveResource} from '../../api/api';
